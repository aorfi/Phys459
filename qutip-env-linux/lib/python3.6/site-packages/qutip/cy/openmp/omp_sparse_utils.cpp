...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "qutip.cy.openmp.omp_sparse_utils",
        "sources": [
            "qutip/cy/openmp/omp_sparse_utils.pyx"
        ]
    },
    "module_name": "qutip.cy.openmp.omp_sparse_utils"
}
END: Cython Metadata */
...
#define __PYX_HAVE__qutip__cy__openmp__omp_sparse_utils
#define __PYX_HAVE_API__qutip__cy__openmp__omp_sparse_utils
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'qutip.cy.openmp.omp_sparse_utils' */
...
static bool __pyx_f_5qutip_2cy_6openmp_16omp_sparse_utils_omp_tidyup(__Pyx_memviewslice, double, int, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "qutip.cy.openmp.omp_sparse_utils"
extern int __pyx_module_is_main_qutip__cy__openmp__omp_sparse_utils;
int __pyx_module_is_main_qutip__cy__openmp__omp_sparse_utils = 0;

/* Implementation of 'qutip.cy.openmp.omp_sparse_utils' */
...
static PyObject *__pyx_pf_5qutip_2cy_6openmp_16omp_sparse_utils_omp_tidyup(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, double __pyx_v_atol, int __pyx_v_nnz, int __pyx_v_nthr); /* proto */
...
/* "qutip/cy/openmp/omp_sparse_utils.pyx":48
...
static PyObject *__pyx_pw_5qutip_2cy_6openmp_16omp_sparse_utils_1omp_tidyup(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static bool __pyx_f_5qutip_2cy_6openmp_16omp_sparse_utils_omp_tidyup(__Pyx_memviewslice __pyx_v_data, double __pyx_v_atol, CYTHON_UNUSED int __pyx_v_nnz, int __pyx_v_nthr, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_kk;
  double __pyx_v_re;
  double __pyx_v_im;
  bool __pyx_v_re_flag;
  bool __pyx_v_im_flag;
  bool __pyx_v_out_flag;
  bool __pyx_r;
  ...
  __Pyx_RefNannySetupContext("omp_tidyup", 0);

  /* "qutip/cy/openmp/omp_sparse_utils.pyx":51
 *     cdef int kk,
 *     cdef double re, im
 ...
 */
  ...
  /* "qutip/cy/openmp/omp_sparse_utils.pyx":52
 *     cdef double re, im
 *     cdef bool re_flag, im_flag, out_flag = 0
 *     with nogil, parallel(num_threads = nthr):             # <<<<<<<<<<<<<<
 *         for kk in prange(nnz, schedule='static'):
      ...
      /*try:*/ {
        {
            ...
            #endif
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_1, __pyx_t_2, __pyx_t_3, __pyx_t_4, __pyx_t_5, __pyx_t_6, __pyx_t_7, __pyx_t_8) num_threads(__pyx_v_nthr)
            #endif /* _OPENMP */
            {

                /* "qutip/cy/openmp/omp_sparse_utils.pyx":53
 *     cdef bool re_flag, im_flag, out_flag = 0
 *     with nogil, parallel(num_threads = nthr):
 *         for kk in prange(nnz, schedule='static'):             # <<<<<<<<<<<<<<
 *             re_flag = 0
 ...
 */
                ...
                if (1 == 0) abort();
                {
                    ...
                    {
                        #ifdef _OPENMP
                        #pragma omp for lastprivate(__pyx_v_im) lastprivate(__pyx_v_im_flag) firstprivate(__pyx_v_kk) lastprivate(__pyx_v_kk) lastprivate(__pyx_v_out_flag) lastprivate(__pyx_v_re) lastprivate(__pyx_v_re_flag) schedule(static)
                        #endif /* _OPENMP */
                        for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                            {
                                __pyx_v_kk = (int)(0 + 1 * __pyx_t_2);
                                /* Initialize private variables to invalid values */
                                __pyx_v_im = ((double)__PYX_NAN());
                                __pyx_v_im_flag = ((bool)0xbad0bad0);
                                __pyx_v_out_flag = ((bool)0xbad0bad0);
                                __pyx_v_re = ((double)__PYX_NAN());
                                __pyx_v_re_flag = ((bool)0xbad0bad0);

                                /* "qutip/cy/openmp/omp_sparse_utils.pyx":54
 *     with nogil, parallel(num_threads = nthr):
 *         for kk in prange(nnz, schedule='static'):
 *             re_flag = 0             # <<<<<<<<<<<<<<
 *             im_flag = 0
 ...
 */
                                ...
                                /* "qutip/cy/openmp/omp_sparse_utils.pyx":55
 *         for kk in prange(nnz, schedule='static'):
 *             re_flag = 0
 *             im_flag = 0             # <<<<<<<<<<<<<<
 *             re = real(data[kk])
 ...
 */
                                ...
                                /* "qutip/cy/openmp/omp_sparse_utils.pyx":56
 *             re_flag = 0
 *             im_flag = 0
 *             re = real(data[kk])             # <<<<<<<<<<<<<<
 *             im = imag(data[kk])
 ...
 */
                                ...
                                __pyx_v_re = std::real((*((__pyx_t_double_complex *) ( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_data.data) + __pyx_t_4)) ))));

                                /* "qutip/cy/openmp/omp_sparse_utils.pyx":57
 *             im_flag = 0
 *             re = real(data[kk])
 *             im = imag(data[kk])             # <<<<<<<<<<<<<<
 *             if fabs(re) < atol:
 ...
 */
                                ...
                                __pyx_v_im = std::imag((*((__pyx_t_double_complex *) ( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_data.data) + __pyx_t_5)) ))));

                                /* "qutip/cy/openmp/omp_sparse_utils.pyx":58
 *             re = real(data[kk])
 *             im = imag(data[kk])
 *             if fabs(re) < atol:             # <<<<<<<<<<<<<<
 *                 re = 0
 *                 re_flag = 1
 */
                                __pyx_t_6 = ((fabs(__pyx_v_re) < __pyx_v_atol) != 0);
                                if (__pyx_t_6) {

                                  /* "qutip/cy/openmp/omp_sparse_utils.pyx":59
 *             im = imag(data[kk])
 *             if fabs(re) < atol:
 *                 re = 0             # <<<<<<<<<<<<<<
 *                 re_flag = 1
 ...
 */
                                  ...
                                  /* "qutip/cy/openmp/omp_sparse_utils.pyx":60
 *             if fabs(re) < atol:
 *                 re = 0
 *                 re_flag = 1             # <<<<<<<<<<<<<<
 *             if fabs(im) < atol:
 ...
 */
                                ...
                                /* "qutip/cy/openmp/omp_sparse_utils.pyx":61
 *                 re = 0
 *                 re_flag = 1
 *             if fabs(im) < atol:             # <<<<<<<<<<<<<<
 *                 im = 0
 *                 im_flag = 1
 */
                                __pyx_t_6 = ((fabs(__pyx_v_im) < __pyx_v_atol) != 0);
                                if (__pyx_t_6) {

                                  /* "qutip/cy/openmp/omp_sparse_utils.pyx":62
 *                 re_flag = 1
 *             if fabs(im) < atol:
 *                 im = 0             # <<<<<<<<<<<<<<
 *                 im_flag = 1
 ...
 */
                                  ...
                                  /* "qutip/cy/openmp/omp_sparse_utils.pyx":63
 *             if fabs(im) < atol:
 *                 im = 0
 *                 im_flag = 1             # <<<<<<<<<<<<<<
 *             if re_flag or im_flag:
 ...
 */
                                ...
                                /* "qutip/cy/openmp/omp_sparse_utils.pyx":64
 *                 im = 0
 *                 im_flag = 1
 *             if re_flag or im_flag:             # <<<<<<<<<<<<<<
 *                 data[kk] = re +1j*im
 ...
 */
                                __pyx_t_7 = (__pyx_v_re_flag != 0);
                                if (!__pyx_t_7) {
                                } else {
                                  __pyx_t_6 = __pyx_t_7;
                                  goto __pyx_L17_bool_binop_done;
                                }
                                __pyx_t_7 = (__pyx_v_im_flag != 0);
                                __pyx_t_6 = __pyx_t_7;
                                __pyx_L17_bool_binop_done:;
                                if (__pyx_t_6) {

                                  /* "qutip/cy/openmp/omp_sparse_utils.pyx":65
 *                 im_flag = 1
 *             if re_flag or im_flag:
 *                 data[kk] = re +1j*im             # <<<<<<<<<<<<<<
 *             if re_flag and im_flag:
 ...
 */
                                  ...
                                  *((__pyx_t_double_complex *) ( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_data.data) + __pyx_t_8)) )) = __Pyx_c_sum_double(__pyx_t_double_complex_from_parts(__pyx_v_re, 0), __Pyx_c_prod_double(__pyx_t_double_complex_from_parts(0, 1.0), __pyx_t_double_complex_from_parts(__pyx_v_im, 0)));
 ...
 */
                                ...
                                /* "qutip/cy/openmp/omp_sparse_utils.pyx":66
 *             if re_flag or im_flag:
 *                 data[kk] = re +1j*im
 *             if re_flag and im_flag:             # <<<<<<<<<<<<<<
 *                 out_flag = 1
 ...
 */
                                ...
                                if (__pyx_t_6) {
                                  ...
                                  /* "qutip/cy/openmp/omp_sparse_utils.pyx":67
 *                 data[kk] = re +1j*im
 *             if re_flag and im_flag:
 *                 out_flag = 1             # <<<<<<<<<<<<<<
 *     return out_flag
 ...
 */
  ...
  /* "qutip/cy/openmp/omp_sparse_utils.pyx":68
 *             if re_flag and im_flag:
 *                 out_flag = 1
 *     return out_flag             # <<<<<<<<<<<<<<
 */
  __pyx_r = __pyx_v_out_flag;
  goto __pyx_L0;
...
/* Python wrapper */
static PyObject *__pyx_pw_5qutip_2cy_6openmp_16omp_sparse_utils_1omp_tidyup(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5qutip_2cy_6openmp_16omp_sparse_utils_1omp_tidyup(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("omp_tidyup (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_data,&__pyx_n_s_atol,&__pyx_n_s_nnz,&__pyx_n_s_nthr,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_atol)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("omp_tidyup", 1, 4, 4, 1); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nnz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("omp_tidyup", 1, 4, 4, 2); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nthr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("omp_tidyup", 1, 4, 4, 3); __PYX_ERR(0, 48, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "omp_tidyup") < 0)) __PYX_ERR(0, 48, __pyx_L3_error)
      }
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dc___pyx_t_double_complex(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_atol = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_atol == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_nnz = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_nnz == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_nthr = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_nthr == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("omp_tidyup", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 48, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("qutip.cy.openmp.omp_sparse_utils.omp_tidyup", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5qutip_2cy_6openmp_16omp_sparse_utils_omp_tidyup(__pyx_self, __pyx_v_data, __pyx_v_atol, __pyx_v_nnz, __pyx_v_nthr);
...
static PyObject *__pyx_pf_5qutip_2cy_6openmp_16omp_sparse_utils_omp_tidyup(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, double __pyx_v_atol, int __pyx_v_nnz, int __pyx_v_nthr) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("omp_tidyup", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_data.memview)) { __Pyx_RaiseUnboundLocalError("data"); __PYX_ERR(0, 48, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyBool_FromLong(__pyx_f_5qutip_2cy_6openmp_16omp_sparse_utils_omp_tidyup(__pyx_v_data, __pyx_v_atol, __pyx_v_nnz, __pyx_v_nthr, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "qutip.cy.openmp.omp_sparse_utils.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "qutip.cy.openmp.omp_sparse_utils.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "qutip.cy.openmp.omp_sparse_utils.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "qutip.cy.openmp.omp_sparse_utils._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"omp_tidyup", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5qutip_2cy_6openmp_16omp_sparse_utils_1omp_tidyup, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_omp_sparse_utils(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_omp_sparse_utils},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initomp_sparse_utils(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initomp_sparse_utils(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_omp_sparse_utils(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_omp_sparse_utils(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_omp_sparse_utils(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'omp_sparse_utils' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_omp_sparse_utils(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("omp_sparse_utils", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_qutip__cy__openmp__omp_sparse_utils) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "qutip.cy.openmp.omp_sparse_utils")) {
      if (unlikely(PyDict_SetItemString(modules, "qutip.cy.openmp.omp_sparse_utils", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "qutip/cy/openmp/omp_sparse_utils.pyx":34
 ...
 */
  ...
  /* "qutip/cy/openmp/omp_sparse_utils.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init qutip.cy.openmp.omp_sparse_utils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init qutip.cy.openmp.omp_sparse_utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
